...
namespace EvilDecompiler.Decompiler.Instruction
{
    ...
    {
        public QuickJsInstructionPop(long pc, QuickJsOPCode opCode, QuickJsOperand operand, JsFunctionBytecode quickJsMethod, AtomSet atoms) : base(pc, opCode, operand, quickJsMethod, atoms)
        {
        }
    }
}
