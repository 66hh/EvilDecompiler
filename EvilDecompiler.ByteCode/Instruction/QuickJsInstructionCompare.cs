...
namespace EvilDecompiler.ByteCode.Instruction
{
    public class QuickJsInstructionCompare : QuickJsInstruction
    {
        ...
        public QuickJsInstructionCompare(long pc, QuickJsOPCode opCode, byte[] operand, JsFunctionBytecode quickJsMethod, AtomSet atoms) : base(pc, opCode, operand, quickJsMethod, atoms)
        {
